                ...
                <div class="card-body">
                    <form action="{{ route('setting.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <div>
                                    <img src="{{ asset($setting->logo ?? "") }}" alt="{{ $setting->logo_alt  ?? ""}}" class="img-fluid">
                                </div>
                            ...
                            <div class="col-6 mb-3">
                                <div>
                                    <img src="{{ asset($setting->favicon ?? "") }}" alt="{{ $setting->favicon ?? ""}}" class="img-fluid">
                                </div>
                            ...
                            <div class="col-6 d-grid mx-auto">
                                <button class="btn btn-success"><i class="fa-regular fa-circle-check"></i> Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
