<header class="navbar navbar-expand-xl navbar-light" >
    <div class="container container-wd">
        ...
        <a class="navbar-brand ms-0" href="index.html">
            <img src="{{ asset($setting->logo) }}" class="navbar-brand-img" alt="{{ $setting->logo_alt }}"/>
        </a>
        ...
        <div class="collapse navbar-collapse z-index-lg" id="navbarCollapse">
            ...
            <ul class="navbar-nav ms-5">
                ...
                <li class="nav-item">
                    <a class="nav-link px-xl-4" id="navbarCourses" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                        {{ $item->name }}
                    </a>
                </li>
                @endforeach
